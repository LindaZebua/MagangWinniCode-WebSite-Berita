                            ...
                            <div class="card-body">
                                <form action="{{ route('comments.update', $comment) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment_text" id="comment_text" class="form-control" required>{{ $comment->comment_text }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="news_id" id="news_id" class="form-control" required>
                                            ...
                                            @foreach($news as $newsItem)
                                                <option value="{{ $newsItem->news_id }}" {{ $comment->news_id == $newsItem->news_id ? 'selected' : '' }}>{{ $newsItem->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
