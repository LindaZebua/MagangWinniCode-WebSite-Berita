...
<head>
    <meta charset="utf-8">
    <title>News tentang Linda</title>
                ...
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" href="#">{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</a>
                        </li>
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" href="#">Advertise</a>
                        </li>
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" href="{{ route('home.contact') }}">Contact</a> {{-- Perbaiki route contact --}}
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body small" href="{{ route('login') }}">Login</a> {{-- Perbaiki route login --}}
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand p-0 d-none d-lg-block">
                    <h1 class="m-0 display-4 text-uppercase text-primary">Breaking<span class="text-secondary font-weight-normal">News</span></h1>
                </a>
            </div>
            ...
            <div class="col-lg-7 px-0">
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        ...
                        <img class="img-fluid h-100" src="{{ Storage::url('uploads/' . $newsItem->gambar_berita) }}" style="object-fit: cover;">
                        <div class="overlay">
                            <div class="mb-2">
                            ...
                            <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="{{ route('news.single', $newsItem->news_id) }}">
                                {{ $newsItem->title }}
                            </a>
                        </div>
                    </div>
                ...
                <div class="row mx-0">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px;">
                            ...
                            <img class="img-fluid h-100" src="{{ Storage::url('uploads/' . $sideNewsItem->gambar_berita) }}" style="object-fit: cover;">
                            <div class="overlay">
                                <div class="mb-2">
                                    {{-- Tampilkan kategori berita untuk bagian kecil --}}
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                        href="{{ route('category.news', $sideNewsItem->category->category_id) }}">
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-bold" href="{{ route('news.single', $sideNewsItem->news_id) }}">
                                    {{ $sideNewsItem->title }}
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center ml-3"
                            ...
                            <div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="">Aplikasi berita buatan mahasiswa lokal mendadak viral karena mampu menyarankan berita sesuai emosi pengguna. Katanya sih, AI-nya peka banget!</a></div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel news-carousel carousel-item-4 position-relative">
            ...
            <div class="position-relative overflow-hidden" style="height: 300px;">
                {{-- Gunakan optional() helper dan null coalescing untuk menangani kasus tanpa media --}}
                <img class="img-fluid h-100" src="{{ Storage::url(optional($newsItem->media->first())->file_path ?? 'img/default-news-image.jpg') }}" style="object-fit: cover;" alt="{{ $newsItem->title }}">
                <div class="overlay">
                    <div class="mb-2">
                        ...
                        @else
                            ...
                            <span class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2">Uncategorized</span>
                        @endif

                        {{-- Pastikan published_at ada --}}
                        <a class="text-white" href="{{ route('news.show', $newsItem->news_id) }}">
                            <small>{{ \Carbon\Carbon::parse($newsItem->published_at)->format('M d, Y') }}</small>
                        </a>
                    </div>
                    <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="{{ route('news.show', $newsItem->news_id) }}">
...
<div class="col-lg-3 col-md-6 mb-5">
    ...
    <div class="m-n1">
        @foreach($categories as $category)
            <a href="{{ route('category.news', $category->category_id) }}" class="btn btn-sm btn-secondary m-1">{{ $category->category_name }}</a>
        @endforeach
    </div>
</div>
