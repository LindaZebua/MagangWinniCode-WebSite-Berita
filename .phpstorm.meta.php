...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\Berita02\public\storage' => 'string',
...
'auth.guards.user.driver','auth.guards.user.provider','auth.providers.users.driver','auth.providers.users.model','auth.passwords.users.provider',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\Berita02\\public\\storage',
...
'web','api',);
        registerArgumentsSet('routes', 'beranda','home.category','home.show','login',
'auth.verify','register','register.submit','dashboard.resetPassword','verify.email',
'logout','dashboard.index','dashboard.home','users.index',
'users.create','users.store','users.show','users.edit','users.update',
'users.destroy','news.index','news.create','news.store','news.show',
'news.edit','news.update','news.destroy','categories.index','categories.create',
'categories.store','categories.show','categories.edit','categories.update','categories.destroy',
'comment.index','comments.create','comments.edit','comments.update','comments.destroy',
'comment.store','media.index','media.create','media.store','media.show',
'media.edit','media.update','media.destroy','profil.index','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','content.categories.create','content.categories.edit','content.categories.index',
'content.categories.show','content.comments.create','content.comments.edit','content.comments.index','content.layouts.home',
'content.layouts.main','content.media.create','content.media.edit','content.media.index','content.media.show',
'content.news.create','content.news.edit','content.news.index','content.news.show','content.profile',
'content.resetPassword','content.users.create','content.users.edit','content.users.index','content.users.show',
'frontend.categories','frontend.show','frontend.welcome','welcome','laravel-exceptions-renderer::components.card',
