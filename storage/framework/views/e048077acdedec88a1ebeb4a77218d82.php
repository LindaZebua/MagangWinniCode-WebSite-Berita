...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/profile-menu.css')); ?>">
    ...
    <link href="<?php echo e(asset('assets/vendor/mdi-font/css/material-design-iconic-font.min.css')); ?>" rel="stylesheet"
        media="all">
...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="<?php echo e(route('dashboard.index')); ?>">
                            <img src="<?php echo e(asset('assets/images/icon/Berita02.png')); ?>" alt="Berita" />
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?php echo e(route('dashboard.index')); ?>">
                    <img src="<?php echo e(asset('assets/images/icon/Berita551.png')); ?>" alt="Berita" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo e(asset('assets/images/icon/avatar-01.jpg')); ?>" alt="login" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="<?php echo e(route('profil.index')); ?>">login</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?php echo e(asset('assets/images/icon/user-interface.jpg')); ?>"
                                                            alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
    ...
    <script src="<?php echo e(asset('assts/js/main.js')); ?>"></script>

</body>

</html><?php /**PATH C:\laragon\www\Berita02\resources\views/content/layouts/main.blade.php ENDPATH**/ ?>